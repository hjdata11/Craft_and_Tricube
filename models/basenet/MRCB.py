...
ROTATION_SCALE = {0 : 1, 30 : 2/(1+sqrt(3)), 45 : 1/sqrt(2), 60 : 2/(1+sqrt(3)), 90 : 1}

# conversion tensor type
def to_half(_list):
...
class Multi_Rotation_Convolution_Block(nn.Module):
    def __init__(self, in_planes):
        ...
        self.conv_1 = conv3x3_bn_relu(in_planes, in_planes)
        self.conv_2 = conv3x3_bn_relu(in_planes, in_planes)
        self.conv_3 = conv3x3_bn_relu(in_planes, in_planes)
        self.conv_4 = conv3x3_bn_relu(in_planes, in_planes)

        self.conv_last = conv3x3_bn_relu(in_planes, in_planes)
...
if __name__ == '__main__':
    ...
    MRCB = Multi_Rotation_Convolution_Block_light(256).to(device)
    print(MRCB)
