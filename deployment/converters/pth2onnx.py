...
from models.basenet.craft import CRAFT
...
def build_onnx(args):
    ...
    output_detec = os.path.join(output_path, "model.onnx")
    
    # Dummy input data for models
    input_tensor_detec = torch.randn((1, 3, 1024, 1024), requires_grad=False)
